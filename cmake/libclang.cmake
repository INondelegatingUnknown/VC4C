...
if(NOT LIBCLANG_LIBRARIES)
	...
	find_library(LIBCLANG_LIBRARY_API_NOTES NAMES clangAPINotes libclangAPINotes PATHS ${LLVM_LIBS_PATH})
	find_library(LIBCLANG_LIBRARY_SUPPORT NAMES clangSupport libclangSupport PATHS ${LLVM_LIBS_PATH})
	find_library(LIBCLANG_LIBRARY_AST_MATCHERS NAMES clangASTMatchers libclangASTMatchers PATHS ${LLVM_LIBS_PATH})
	find_library(LIBCLANG_LIBRARY_BASIC NAMES clangBasic libclangBasic PATHS ${LLVM_LIBS_PATH})

	if(LIBCLANG_LIBRARY_ANALYSIS AND LIBCLANG_LIBRARY_AST AND LIBCLANG_LIBRARY_BASIC AND LIBCLANG_LIBRARY_CODEGEN AND LIBCLANG_LIBRARY_DRIVER AND LIBCLANG_LIBRARY_EDIT AND LIBCLANG_LIBRARY_FRONTEND AND LIBCLANG_LIBRARY_LEX AND LIBCLANG_LIBRARY_PARSE AND LIBCLANG_LIBRARY_SEMA AND LIBCLANG_LIBRARY_SERIALIZATION AND LIBCLANG_LIBRARY_API_NOTES AND LIBCLANG_LIBRARY_SUPPORT AND LIBCLANG_LIBRARY_AST_MATCHERS AND LIBCLANG_LIBRARY_BASIC)
		set(LIBCLANG_LIBRARIES ${LIBCLANG_LIBRARY_ANALYSIS} ${LIBCLANG_LIBRARY_AST} ${LIBCLANG_LIBRARY_BASIC} ${LIBCLANG_LIBRARY_CODEGEN} ${LIBCLANG_LIBRARY_DRIVER} ${LIBCLANG_LIBRARY_EDIT} ${LIBCLANG_LIBRARY_FRONTEND} ${LIBCLANG_LIBRARY_LEX} ${LIBCLANG_LIBRARY_PARSE} ${LIBCLANG_LIBRARY_SEMA} ${LIBCLANG_LIBRARY_SERIALIZATION} ${LIBCLANG_LIBRARY_API_NOTES} ${LIBCLANG_LIBRARY_SUPPORT} ${LIBCLANG_LIBRARY_AST_MATCHERS} ${LIBCLANG_LIBRARY_BASIC})
	else()
