...
TestInstructions::TestInstructions()
{
    ...
    TEST_ADD(TestInstructions::testBranchConditions);
...
void TestInstructions::testConditionCodes()
{
    ...
    TEST_ASSERT_EQUALS(BRANCH_ALWAYS, COND_ALWAYS.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ALL_C_CLEAR, COND_CARRY_CLEAR.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ANY_C_SET, COND_CARRY_SET.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ALL_N_CLEAR, COND_NEGATIVE_CLEAR.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ANY_N_SET, COND_NEGATIVE_SET.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ALL_Z_CLEAR, COND_ZERO_CLEAR.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ANY_Z_SET, COND_ZERO_SET.toBranchCondition())
    TEST_ASSERT_EQUALS(BRANCH_ALWAYS, COND_ALWAYS.toBranchCondition(true))
    TEST_ASSERT_EQUALS(BRANCH_ANY_C_CLEAR, COND_CARRY_CLEAR.toBranchCondition(true))
    TEST_ASSERT_EQUALS(BRANCH_ALL_C_SET, COND_CARRY_SET.toBranchCondition(true))
    TEST_ASSERT_EQUALS(BRANCH_ANY_N_CLEAR, COND_NEGATIVE_CLEAR.toBranchCondition(true))
    TEST_ASSERT_EQUALS(BRANCH_ALL_N_SET, COND_NEGATIVE_SET.toBranchCondition(true))
    TEST_ASSERT_EQUALS(BRANCH_ANY_Z_CLEAR, COND_ZERO_CLEAR.toBranchCondition(true))
    TEST_ASSERT_EQUALS(BRANCH_ALL_Z_SET, COND_ZERO_SET.toBranchCondition(true))

    TEST_ASSERT_EQUALS(COND_ALWAYS, COND_ALWAYS.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_CARRY_CLEAR, COND_CARRY_CLEAR.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_CARRY_SET, COND_CARRY_SET.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_NEGATIVE_CLEAR, COND_NEGATIVE_CLEAR.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_NEGATIVE_SET, COND_NEGATIVE_SET.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_ZERO_CLEAR, COND_ZERO_CLEAR.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_ZERO_SET, COND_ZERO_SET.toBranchCondition().toConditionCode())
    TEST_ASSERT_EQUALS(COND_ALWAYS, COND_ALWAYS.toBranchCondition(true).toConditionCode())
    TEST_ASSERT_EQUALS(COND_CARRY_CLEAR, COND_CARRY_CLEAR.toBranchCondition(true).toConditionCode())
    TEST_ASSERT_EQUALS(COND_CARRY_SET, COND_CARRY_SET.toBranchCondition(true).toConditionCode())
    TEST_ASSERT_EQUALS(COND_NEGATIVE_CLEAR, COND_NEGATIVE_CLEAR.toBranchCondition(true).toConditionCode())
    TEST_ASSERT_EQUALS(COND_NEGATIVE_SET, COND_NEGATIVE_SET.toBranchCondition(true).toConditionCode())
    TEST_ASSERT_EQUALS(COND_ZERO_CLEAR, COND_ZERO_CLEAR.toBranchCondition(true).toConditionCode())
    TEST_ASSERT_EQUALS(COND_ZERO_SET, COND_ZERO_SET.toBranchCondition(true).toConditionCode())
}
...
void TestInstructions::testUnpackModes()
{
    ...
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_NOP.getInputMask())
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_NOP(BITMASK_ALL, false))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FFFF}, UNPACK_16A_32.getInputMask())
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_16A_32(BitMask{0x0000FFFF}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_16A_32(BitMask{0x0000FFFF}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_16A_32(BitMask{0xFFFF0000}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_16A_32(BitMask{0xFFFF0000}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFF0000}, UNPACK_16B_32.getInputMask())
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_16B_32(BitMask{0x0000FFFF}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_16B_32(BitMask{0x0000FFFF}, true))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_16B_32(BitMask{0xFFFF0000}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_16B_32(BitMask{0xFFFF0000}, true))

    TEST_ASSERT_EQUALS(INT_MINUS_ONE, UNPACK_8888_32(INT_MINUS_ONE))
    TEST_ASSERT_EQUALS(INT_MINUS_ONE, UNPACK_8888_32(Value(Literal(0xFF000000), TYPE_INT8)))
    TEST_ASSERT_EQUALS(INT_ZERO, UNPACK_8888_32(INT_ZERO))
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, UNPACK_8888_32.getInputMask())
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_8888_32(BitMask{0xFF000000}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_8888_32(BitMask{0xFF000000}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8888_32(BitMask{0x00FFFFFF}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8888_32(BitMask{0x00FFFFFF}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, UNPACK_8A_32.getInputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, UNPACK_8A_32(BitMask{0x000000FF}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_8A_32(BitMask{0x000000FF}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8A_32(BitMask{0xFFFFFF00}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8A_32(BitMask{0xFFFFFF00}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, UNPACK_8B_32.getInputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, UNPACK_8B_32(BitMask{0x0000FF00}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_8B_32(BitMask{0x0000FF00}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8B_32(BitMask{0xFFFF00FF}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8B_32(BitMask{0xFFFF00FF}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, UNPACK_8C_32.getInputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, UNPACK_8C_32(BitMask{0x00FF0000}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_8C_32(BitMask{0x00FF0000}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8C_32(BitMask{0xFF00FFFF}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8C_32(BitMask{0xFF00FFFF}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, UNPACK_8D_32.getInputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, UNPACK_8D_32(BitMask{0xFF000000}, false))
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_8D_32(BitMask{0xFF000000}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8D_32(BitMask{0x00FFFFFF}, false))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_8D_32(BitMask{0x00FFFFFF}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FFFF}, UNPACK_R4_16A_32.getInputMask())
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_R4_16A_32(BitMask{0x0000FFFF}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_R4_16A_32(BitMask{0xFFFF0000}, true))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFF0000}, UNPACK_R4_16B_32.getInputMask())
    TEST_ASSERT_EQUALS(BITMASK_ALL, UNPACK_R4_16B_32(BitMask{0xFFFF0000}, true))
    TEST_ASSERT_EQUALS(BITMASK_NONE, UNPACK_R4_16B_32(BitMask{0x0000FFFF}, true))
...
void TestInstructions::testPackModes()
{
    ...
    TEST_ASSERT_EQUALS(BITMASK_ALL, PACK_NOP.getOutputMask())
    TEST_ASSERT_EQUALS(BITMASK_ALL, PACK_NOP(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FFFF}, PACK_32_16A.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x0000FFFF}, PACK_32_16A(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFF0000}, PACK_32_16B.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFFFF0000}, PACK_32_16B(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFFFFFF}, PACK_32_8888.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFFFFFFFF}, PACK_32_8888(BITMASK_ALL))

    TEST_ASSERT_EQUALS(Value(Literal(0xFF), TYPE_INT8), PACK_32_8A(INT_MINUS_ONE, {}))
    TEST_ASSERT_EQUALS(INT_ZERO, PACK_32_8A(INT_ZERO, {}))
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, PACK_32_8A.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, PACK_32_8A(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, PACK_32_8B.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, PACK_32_8B(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, PACK_32_8C.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, PACK_32_8C(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, PACK_32_8D.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, PACK_32_8D(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FFFF}, PACK_32_16A_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x0000FFFF}, PACK_32_16A_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFF0000}, PACK_32_16B_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFFFF0000}, PACK_32_16B_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFFFFFF}, PACK_32_8888_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFFFFFFFF}, PACK_32_8888_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, PACK_32_8A_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, PACK_32_8A_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, PACK_32_8B_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, PACK_32_8B_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, PACK_32_8C_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, PACK_32_8C_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, PACK_32_8D_S.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, PACK_32_8D_S(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFFFFFFFF}, PACK_MUL_GRAY_REPLICATE.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFFFFFFFF}, PACK_MUL_GRAY_REPLICATE(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, PACK_MUL_COLOR0.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x000000FF}, PACK_MUL_COLOR0(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, PACK_MUL_COLOR1.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, PACK_MUL_COLOR1(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, PACK_MUL_COLOR2.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0x00FF0000}, PACK_MUL_COLOR2(BITMASK_ALL))
    ...
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, PACK_MUL_COLOR3.getOutputMask())
    TEST_ASSERT_EQUALS(BitMask{0xFF000000}, PACK_MUL_COLOR3(BITMASK_ALL))
...
void TestInstructions::testOpCodes()
{
    ...
    TEST_ASSERT_EQUALS(BitMask{0x0000FF00}, OP_AND(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)
    ...
    TEST_ASSERT_EQUALS(BitMask{32 + 31}, OP_CLZ(BITMASK_ALL, BITMASK_NONE).resultMask)
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FFFFFF}, OP_OR(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FFFFFF}, OP_V8ADDS(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FFFFFF}, OP_V8MAX(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FFFFFF}, OP_V8MIN(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)

    TEST_ASSERT_EQUALS(INT_ZERO, OP_V8SUBS(INT_ONE, INT_ONE).first.value())
    TEST_ASSERT_EQUALS(INT_ONE, OP_V8SUBS(INT_ONE, INT_ZERO).first.value())
    TEST_ASSERT_EQUALS(BitMask{0x00FFFFFF}, OP_V8SUBS(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)
    ...
    TEST_ASSERT_EQUALS(BitMask{0x00FFFFFF}, OP_V8MULD(BitMask{0x00FFFF00}, BitMask{0x0000FFFF}).resultMask)
}
...
void TestInstructions::testBranchConditions()
{
    TEST_ASSERT(BRANCH_ALL_Z_SET.isInversionOf(BRANCH_ANY_Z_CLEAR));
    TEST_ASSERT(BRANCH_ALL_Z_CLEAR.isInversionOf(BRANCH_ANY_Z_SET));
    TEST_ASSERT(BRANCH_ANY_Z_SET.isInversionOf(BRANCH_ALL_Z_CLEAR));
    TEST_ASSERT(BRANCH_ANY_Z_CLEAR.isInversionOf(BRANCH_ALL_Z_SET));
    TEST_ASSERT(BRANCH_ALL_N_SET.isInversionOf(BRANCH_ANY_N_CLEAR));
    TEST_ASSERT(BRANCH_ALL_N_CLEAR.isInversionOf(BRANCH_ANY_N_SET));
    TEST_ASSERT(BRANCH_ANY_N_SET.isInversionOf(BRANCH_ALL_N_CLEAR));
    TEST_ASSERT(BRANCH_ANY_N_CLEAR.isInversionOf(BRANCH_ALL_N_SET));
    TEST_ASSERT(BRANCH_ALL_C_SET.isInversionOf(BRANCH_ANY_C_CLEAR));
    TEST_ASSERT(BRANCH_ALL_C_CLEAR.isInversionOf(BRANCH_ANY_C_SET));
    TEST_ASSERT(BRANCH_ANY_C_SET.isInversionOf(BRANCH_ALL_C_CLEAR));
    TEST_ASSERT(BRANCH_ANY_C_CLEAR.isInversionOf(BRANCH_ALL_C_SET));

    TEST_ASSERT_EQUALS(BRANCH_ANY_Z_CLEAR, BRANCH_ALL_Z_SET.invert());
    TEST_ASSERT_EQUALS(BRANCH_ANY_Z_SET, BRANCH_ALL_Z_CLEAR.invert());
    TEST_ASSERT_EQUALS(BRANCH_ALL_Z_CLEAR, BRANCH_ANY_Z_SET.invert());
    TEST_ASSERT_EQUALS(BRANCH_ALL_Z_SET, BRANCH_ANY_Z_CLEAR.invert());
    TEST_ASSERT_EQUALS(BRANCH_ANY_N_CLEAR, BRANCH_ALL_N_SET.invert());
    TEST_ASSERT_EQUALS(BRANCH_ANY_N_SET, BRANCH_ALL_N_CLEAR.invert());
    TEST_ASSERT_EQUALS(BRANCH_ALL_N_CLEAR, BRANCH_ANY_N_SET.invert());
    TEST_ASSERT_EQUALS(BRANCH_ALL_N_SET, BRANCH_ANY_N_CLEAR.invert());
    TEST_ASSERT_EQUALS(BRANCH_ANY_C_CLEAR, BRANCH_ALL_C_SET.invert());
    TEST_ASSERT_EQUALS(BRANCH_ANY_C_SET, BRANCH_ALL_C_CLEAR.invert());
    TEST_ASSERT_EQUALS(BRANCH_ALL_C_CLEAR, BRANCH_ANY_C_SET.invert());
    TEST_ASSERT_EQUALS(BRANCH_ALL_C_SET, BRANCH_ANY_C_CLEAR.invert());

    TEST_ASSERT_EQUALS(COND_ZERO_SET, BRANCH_ALL_Z_SET.toConditionCode());
    TEST_ASSERT_EQUALS(COND_ZERO_CLEAR, BRANCH_ALL_Z_CLEAR.toConditionCode());
    TEST_ASSERT_EQUALS(COND_ZERO_SET, BRANCH_ANY_Z_SET.toConditionCode());
    TEST_ASSERT_EQUALS(COND_ZERO_CLEAR, BRANCH_ANY_Z_CLEAR.toConditionCode());
    TEST_ASSERT_EQUALS(COND_NEGATIVE_SET, BRANCH_ALL_N_SET.toConditionCode());
    TEST_ASSERT_EQUALS(COND_NEGATIVE_CLEAR, BRANCH_ALL_N_CLEAR.toConditionCode());
    TEST_ASSERT_EQUALS(COND_NEGATIVE_SET, BRANCH_ANY_N_SET.toConditionCode());
    TEST_ASSERT_EQUALS(COND_NEGATIVE_CLEAR, BRANCH_ANY_N_CLEAR.toConditionCode());
    TEST_ASSERT_EQUALS(COND_CARRY_SET, BRANCH_ALL_C_SET.toConditionCode());
    TEST_ASSERT_EQUALS(COND_CARRY_CLEAR, BRANCH_ALL_C_CLEAR.toConditionCode());
...
void TestInstructions::testValue()
{
    ...
    TEST_ASSERT_EQUALS(ELEMENT_NUMBER_REGISTER.getReadMask(), ELEMENT_NUMBERS.getReadMask());
}
